...
class Resolver {
  ...
  _specifierSpellings(specifier) {
    if (!(0, _nodeModule().isBuiltin)(specifier)) {
      return [specifier];
    }
    if (specifier.startsWith('node:')) {
      const bareSpecifier = specifier.slice(5);
      return (0, _nodeModule().isBuiltin)(bareSpecifier) ? [specifier, bareSpecifier] : [specifier];
    }
    return [specifier, `node:${specifier}`];
  }
  _matchModuleNameMapper(regex, moduleName) {
